...
import com.example.bigo.databinding.P74CotestProBinding
import com.google.firebase.firestore.FirebaseFirestore

class cotestQ_pro : AppCompatActivity() {
    val coQuestion = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = P74CotestProBinding.inflate(layoutInflater)
        ...
        binding.result.setOnClickListener {
            ...
            coQ.clear()
            coQ.add(coQParcel(coid, coName, answer, "pro"))
