...
class sqlQ_pro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.result.setOnClickListener {
            ...
            sqlQ.clear()
            sqlQ.add(sqlQParcel(sqlid, sqlName, answer, "pro"))
